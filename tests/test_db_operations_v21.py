...
class TestDBOperationV21:
    """Tests for the DBOperation class with v21 format."""
...
class TestAnkiV21OperationGenerator:
    """Tests for the AnkiV21OperationGenerator class."""
    
    def setup_method(self):
        self.generator = AnkiV21OperationGenerator()
